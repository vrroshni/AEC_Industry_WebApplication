										...
										<div className="profile-statistics">
											<div className="text-center">
												...
												<div className="mt-4">
													...
													<a href="javascript:void(0);" className="btn btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#sendMessageModal">Send Message</a>
												</div>
											</div>
                                        ...
                                        <div className="tab-content">
														...
														<div className="modal fade" id="linkModal">
															<div className="modal-dialog modal-dialog-centered" role="document">
																<div className="modal-content">
																	...
																	<div className="modal-body">
																		<a className="btn-social facebook" href="javascript:void(0)"><i className="fa fa-facebook"></i></a>
																		<a className="btn-social google-plus" href="javascript:void(0)"><i className="fa fa-google-plus"></i></a>
																		<a className="btn-social linkedin" href="javascript:void(0)" ><i className="fa fa-linkedin"></i></a>
																		<a className="btn-social instagram" href="javascript:void(0)"><i className="fa fa-instagram"></i></a>
																		<a className="btn-social twitter" href="javascript:void(0)"><i className="fa fa-twitter"></i></a>
																		<a className="btn-social youtube" href="javascript:void(0)"><i className="fa fa-youtube"></i></a>
																		<a className="btn-social whatsapp" href="javascript:void(0)"><i className="fa fa-whatsapp"></i></a>
																	</div>
																</div>
															</div>
														</div>
                                                        <a href="javascript:void(0);" className="btn btn-primary light me-1 px-3" data-bs-toggle="modal" data-bs-target="#cameraModal"><i className="fa fa-camera m-0"></i> </a>
                                            ...
                                            <div id="about-me" className="tab-pane fade">
                                                ...
                                                <div className="profile-lang  mb-5">
													...
													<a href="javascript:void(0);" className="text-muted pe-3 f-s-16"><i className="flag-icon flag-icon-us"></i> English</a> 
													<a href="javascript:void(0);" className="text-muted pe-3 f-s-16"><i className="flag-icon flag-icon-fr"></i> French</a>
                                                    <a href="javascript:void(0);" className="text-muted pe-3 f-s-16"><i className="flag-icon flag-icon-bd"></i> Bangla</a>
                                                </div>
                                                <div className="profile-personal-info">
                                                    ...
                                                    <div className="row mb-2">
                                                        <div className="col-sm-3 col-5">
                                                            <h5 className="f-w-500">Availability <span className="pull-end">:</span></h5>
                                                        </div>
