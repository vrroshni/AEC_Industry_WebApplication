...
const Section4 = () => {
    return (
        <div className="row mt-3">
            <div className="col-xl-12 col-xxl-12 col-lg-12 text-center">
                <h3 className='mt-1 text-black'>Our Big Projects <span className='text-primary'>...</span></h3>
            </div>
            <div class="col-xl-3 col-xxl-3 col-sm-6 text-center">
                <div class="card">
